...
public class Hibernate42Test extends Assert {
    ...
    public Option[] commonOptions() {
        ...
        return new Option[]{
                ...
                mavenBundle().groupId("com.github.micromix").artifactId("micromix-conflet-hibernate42-springdm-itest-datasource").version("0.6-SNAPSHOT"),
                ...
                bundle("mvn:com.github.micromix/micromix-conflet-hibernate42-springdm/0.6-SNAPSHOT"),
                ...
                mavenBundle().groupId("com.github.micromix").artifactId("micromix-conflet-hibernate42-springdm-itest-business").version("0.6-SNAPSHOT"),
